...
SiriusMemberSchema = new SimpleSchema({
  ...
  father: {
    type: Object,
    label: function () {
      return TAPi18n.__('SiriusMemberSchema.Father.label')
    }
  },
  "father.age": {
    type: Number,
    label: function () {
      return TAPi18n.__('SiriusMemberSchema.Father.age')
    }
  },
  "father.ocupation":{
    type: Number,
    label: function () {
      return TAPi18n.__('SiriusMemberSchema.Father.ocupation')
    },
    allowedValues: Ocupation.values,
    autoform: {
      options: Ocupation.options
  ...
  mother: {
    type: Object,
    label: function () {
      return TAPi18n.__('SiriusMemberSchema.Mother.label')
    }
  },
  "mother.age": {
    type: Number,
    label: function () {
      return TAPi18n.__('SiriusMemberSchema.Mother.age')
    }
  },
  "mother.ocupation":{
    type: Number,
    label: function () {
      return TAPi18n.__('SiriusMemberSchema.Mother.occupation')
    },
    allowedValues: Ocupation.values,
    autoform: {
      options: Ocupation.options
